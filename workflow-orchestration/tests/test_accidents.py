...
def accident_vehicle_merged() -> pandas.DataFrame:  # pylint: disable=missing-function-docstring
    return pandas.read_csv(
        fixtures_dir / "test_accident_vehicle_merged.csv", index_col=None
    )
...
def accident_vehicle_casualty_merged() -> pandas.DataFrame:  # pylint: disable=missing-function-docstring
    return pandas.read_csv(
        fixtures_dir / "test_accident_vehicle_casualty_merged.csv", index_col=None
    )
...
def accident_vehicle_casualty_unified() -> pandas.DataFrame:  # pylint: disable=missing-function-docstring
    data = pandas.read_csv(
        fixtures_dir / "test_accident_vehicle_casualty_unified.csv", index_col=None
    )
...
def accident_vehicle_casualty_preprocessed() -> pandas.DataFrame:  # pylint: disable=missing-function-docstring
    data = pandas.read_csv(
        fixtures_dir / "test_accident_vehicle_casualty_preprocessed.csv", index_col=None
    )
    return data


def test_accidents_vehicles_merged(
    raw_accident, raw_vehicle, accident_vehicle_merged
...
def test_accidents_vehicles_casualties_merged(
    accident_vehicle_merged, raw_casualty, accident_vehicle_casualty_merged
):  # pylint: disable=missing-function-docstring

    merged = accidents.accidents_vehicles_casualties_merged(
        accident_vehicle_merged, raw_casualty
    )
...
def test_accidents_vehicles_casualties_unify(
    ...
    unified = accidents.accidents_vehicles_casualties_unify(
        accident_vehicle_casualty_merged, categorical_mapping
    )
