import pytest
from workflows.models import input_signature_to_schema, type_convert


@pytest.mark.parametrize(
    "inputs, expected_outputs", [("string", str), ("double", float), ("long", int)]
)
...
def test_input_signature_to_schema(
    test_model,
):  # pylint: disable=missing-function-docstring
